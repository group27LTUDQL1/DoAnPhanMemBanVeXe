...
{
    public partial class Form_Xe_16_Cho : Form
    {
        ...
        public Form_Xe_16_Cho()
        {
            Load += Form_Xe_16_Cho_Load;
            InitializeComponent();
        }
        ...
        private void Form_Xe_16_Cho_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (dr.Read() == true)
                {
                    for (int i = 0; i <= grb_16.Controls.Count - 1; i++)
                    {
                        ...
                        {
                            ((DevComponents.DotNetBar.ButtonX)grb_16.Controls[i]).Image = DoAnPhanMemBanVeXe_2.Properties.Resources.hanh_khach;
                        }
                    }
                }
