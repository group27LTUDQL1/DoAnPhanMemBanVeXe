...
namespace DoAnPhanMemBanVeXe_2
{
    public partial class Form_Xe_45_Cho : Form
    {
        ...
        public Form_Xe_45_Cho()
        {
            Load += Form_Xe_45_Cho_Load;
            InitializeComponent();
        }
            ...
            try
            {
                ...
                while (dr.Read() == true)
                {
                    for (int i = 0; i <= grb_45.Controls.Count - 1; i++)
                    {
                        ...
                        {
                            ((DevComponents.DotNetBar.ButtonX)grb_45.Controls[i]).Image = DoAnPhanMemBanVeXe_2.Properties.Resources.hanh_khach;
                        }
                    }
                }
