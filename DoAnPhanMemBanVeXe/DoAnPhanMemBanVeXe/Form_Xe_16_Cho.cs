...
{
    public partial class Form_Xe_16_Cho : DevComponents.DotNetBar.Office2007RibbonForm
    {
        public Form_Xe_16_Cho(Form_Main fm1)
        {
            InitializeComponent();
            fm = fm1;
        }
        ...
        #region "Event duyệt chỗ ngồi hoàn thành"
